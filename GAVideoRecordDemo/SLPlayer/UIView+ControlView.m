...
- (void)setSl_delegate:(id<SLPlayerControlViewDelagate>)sl_delegate {
    objc_setAssociatedObject(self, @selector(sl_delegate), sl_delegate, OBJC_ASSOCIATION_ASSIGN);
}
//- (void)setDelegate:(id<SLPlayerControlViewDelagate>)sl_delegate {
//    objc_setAssociatedObject(self, @selector(delegate), delegate, OBJC_ASSOCIATION_ASSIGN);
//}

- (id<SLPlayerControlViewDelagate>)sl_delegate {
